...
const tpiElements = [
    {
        ...
        paragraph: <div>
            <FacetParagraph>
                A one-time installation of the <FacetLink>facet extension</FacetLink> allows your team to release features seamlessly. Using facet requires no setup or maintenance work.
