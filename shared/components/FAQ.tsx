        ...
        <div>
            ...
            <ol>
                ...
                <li>
                    ...
                    <p>
                        At facet, Security is at the center of our priorities. We have integrated with multiple vendors who champion DevSecOps,including <a href='https://github.com/snyk'>Snyk</a> and <a href='https://github.com/dependabot'>Github</a>, to ensure secure codebases. We are also working on getting ISO, HIIPA and other security compliance licenses.
                    </p>
                </li>
                <li>
